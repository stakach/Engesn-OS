...
int Cmos::read(byte address) /*reads a byte out of the cmos*/
{
	while(busy());
...
int Cmos::read_bcd(byte address)
{
...
int Cmos::bcd2bin(byte bcd) /*binary coded decimal to binary converter*/
{
