...
namespace I386
{
	...
	class PAGER: public MEMORY
	{
		...
		private:
			BOOL GetVirtualAddress(UINT &PhysicalAddress);
			...
			INT NextDirPointer;
			INT NextPaeIndex;
			PAGE_ENTRY_AE *DirPointer;
			PAGE_ENTRY_AE *VDirPointer;
			PAGE_ENTRY_AE *CurDir;
			PAGE_ENTRY_AE *CurPae;
			UINT AddressOfPages;
			UINT numDirEntries;
			UINT baseAddress;
			PAGE_ENTRY_AE *PageTablesTable;
